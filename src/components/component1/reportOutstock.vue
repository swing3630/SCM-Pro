<template>
    <div>
        ...
        <el-button type="primary" @click="queryOutstock">查询</el-button>
        ...
        <el-table :data="tableListOut" border stripe max-height="400px" size="mini">
            <el-table-column prop="soId" label="采购单编号"></el-table-column>
...
<script>
    export default {
        ...
        methods: {
            queryOutstock() {
                this.$axios.get(`/api/main/report/outstock/main?time=${this.searchDate}&page=${this.currentPage}`).then(res => {
                    ...
                    if (res.data.total == 0) {
                        ...
                        this.tableListOut = res.data.details.list
